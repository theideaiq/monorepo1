        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 text-sm mb-6 max-w-xs">
              Baghdad&apos;s premier digital ecosystem. Shopping, Rentals,
              Education, and Corporate Solutions in one unified platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li>
                <Link href="/plus" className="hover:text-brand-pink transition">
                  IDEA Plus
                </Link>
              </li>
              <li>
                <Link
                  href="/megastore?filter=Games"
                  className="hover:text-brand-pink transition"
                >
                  Games
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li>
                <Link href="/faq" className="hover:text-brand-pink transition">
                  Help Center
                </Link>
              </li>
              <li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
          ...
          <div className="text-center md:text-right max-w-2xl">
            ...
            <p>
              ...
              copyright material of their respective owners. All rights
              reserved.
            </p>
          </div>
        </div>
