...
describe('String Utils (@repo/utils)', () => {
  describe('slugify', () => {
    ...
    it('should handle empty, null or undefined input', () => {
      expect(slugify('')).toBe('');
      // TODO: Implement runtime safety for null/undefined
  ...
  describe('decodeHtmlEntities', () => {
    ...
    it('should decode numeric entities', () => {
      ...
      // TODO: Implement hex entity support
      expect(decodeHtmlEntities('&#x41;')).toBe('&#x41;'); // Lowercase hex - currently unsupported
      expect(decodeHtmlEntities('&#X41;')).toBe('&#X41;'); // Uppercase hex - currently unsupported
    });
