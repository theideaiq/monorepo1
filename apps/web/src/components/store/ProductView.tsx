          ...
          <div className="relative aspect-square bg-brand-surface rounded-3xl overflow-hidden border border-white/5">
            ...
            <div className="absolute top-4 left-4">
              {product.condition === 'new' ? (
                <span className="bg-brand-yellow text-brand-dark font-bold px-3 py-1 rounded-full text-xs uppercase tracking-widest">
                  New
                </span>
              ) : (
                <span className="bg-white/10 backdrop-blur text-white font-bold px-3 py-1 rounded-full text-xs uppercase tracking-widest border border-white/10">
                  {product.condition}
                </span>
              )}
            </div>
