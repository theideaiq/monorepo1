...
export function ProductCard({
  ...
  return (
    <motion.div
      whileHover={{ y: -5 }}
      className="group relative block h-full bg-white/5 border border-white/5 rounded-2xl overflow-hidden hover:border-brand-yellow/30 hover:shadow-[0_10px_30px_-10px_rgba(0,0,0,0.5)] transition-all duration-300 flex flex-col focus-within:ring-2 focus-within:ring-brand-yellow"
    >
      <Link
      ...
      <div className="relative aspect-square bg-[#1a1a1a] overflow-hidden">
        ...
        <button
          ...
          className="absolute bottom-3 right-3 z-20 p-3 bg-brand-yellow text-brand-dark rounded-full shadow-lg translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white hover:text-black"
