...
export function ProductCard({
  ...
  return (
    <motion.div
      whileHover={{ y: -5 }}
      className="group relative block h-full bg-white/5 border border-white/5 rounded-2xl overflow-hidden hover:border-brand-yellow/30 hover:shadow-[0_10px_30px_-10px_rgba(0,0,0,0.5)] transition-all duration-300 flex flex-col"
    >
