...
async function getOrCreateCartId(
  // biome-ignore lint/suspicious/noExplicitAny: Supabase client is untyped here
  supabase: any,
  userId: string,
): Promise<string | null> {
...
export async function fetchCartItems(): Promise<CartItem[]> {
  ...
  // biome-ignore lint/suspicious/noExplicitAny: Casting to any for transformation
