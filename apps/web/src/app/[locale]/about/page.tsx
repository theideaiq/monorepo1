      ...
      <section className="bg-brand-dark text-white py-24 px-4 text-center rounded-b-[3rem] relative overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            ...
            <span className="text-brand-pink">Baghdad</span>.
          </h1>
          <p className="text-slate-300 text-lg max-w-2xl mx-auto leading-relaxed">
            The IDEA IQ is not just a company. It is an ecosystem designed to
            bridge the gap between commerce, education, and entertainment for
            the modern Iraqi citizen.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 mt-2">
                  To provide a unified digital identity for every Iraqi,
                  allowing seamless access to premium products, world-class
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 mt-2">
                  A future where &quot;The IDEA&quot; is the standard for trust,
                  quality, and innovation in the Middle East.
                </p>
              </div>
            </div>
          </div>
