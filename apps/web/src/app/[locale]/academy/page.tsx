...
const COURSES = [
  ...
  },
  {
    ...
    level: 'Advanced',
    image:
      'https://images.unsplash.com/photo-1599592237834-0f2c4232a5df?q=80&w=1000&auto=format&fit=crop',
    category: 'Art',
  },
];
...
const ARTICLES = [
  ...
  },
  {
    ...
    tag: 'Industry Trends',
    image:
      'https://images.unsplash.com/photo-1593642632823-8f7853670961?q=80&w=1000',
  },
  {
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12">
            <div className="md:w-1/2">
              <Badge
                variant="brand"
                className="mb-6 bg-blue-600 border-blue-400 text-white"
              >
              ...
              <p className="text-xl text-slate-300 mb-8 leading-relaxed">
                Whether you want to master a new skill online or travel the
                world for a cultural exchange, your journey starts here.
              </p>
            ...
            <div className="md:w-1/2 grid grid-cols-2 gap-4">
              ...
              <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/10">
                <h3 className="text-3xl font-bold text-brand-yellow mb-1">
                  12
                </h3>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {COURSES.map((course) => (
                <Card
                  key={course.id}
                  className="group hover:shadow-xl transition-all duration-300 border-none shadow-sm h-full flex flex-col"
                >
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="text-3xl font-bold text-brand-dark mb-4">
                Bridging Baghdad & The World
              </h2>
              <p className="text-slate-500">
                Our exchange programs are designed to foster deep cultural
                understanding and create lifelong global connections.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <Card className="p-8 border-t-4 border-blue-500 hover:-translate-y-1 transition-transform">
                ...
                <p className="text-slate-600 mb-6 text-sm leading-relaxed">
                  Spend a semester abroad at one of our 12 partner universities
                  in Europe, Japan, or the USA. Full scholarships available for
                  top performers.
                </p>
              ...
              <Card className="p-8 border-t-4 border-brand-pink hover:-translate-y-1 transition-transform">
                ...
                <p className="text-slate-600 mb-6 text-sm leading-relaxed">
                  A collaborative residency for artists and historians to
                  digitize Iraq&apos;s ancient history using VR and AI
                  technology.
                </p>
                <div className="space-y-2 mb-8">
                  <div className="flex items-center gap-2 text-xs font-bold text-slate-500 bg-slate-100 p-2 rounded">
              ...
              <Card className="p-8 border-t-4 border-brand-yellow hover:-translate-y-1 transition-transform">
                ...
                <p className="text-slate-600 mb-6 text-sm leading-relaxed">
                  A weekly digital town hall connecting Iraqi entrepreneurs with
                  Silicon Valley mentors and global thought leaders.
                </p>
                <div className="space-y-2 mb-8">
                  <div className="flex items-center gap-2 text-xs font-bold text-slate-500 bg-slate-100 p-2 rounded">
